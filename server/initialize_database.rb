...
#THIS
create_rhubarb_games = "CREATE  TABLE `rhubarb_games` (`id` INT NOT NULL AUTO_INCREMENT ,`winner` INT NOT NULL ,`loser` INT NOT NULL ,`winner_score` INT NOT NULL ,`loser_score` INT NOT NULL ,`sender_id` INT NOT NULL ,`recipient_id` INT NOT NULL ,`timestamp` INT NOT NULL ,`status` INT NOT NULL ,PRIMARY KEY (`id`) )ENGINE = InnoDB;"
#UGLY
create_rhubarb_players = "CREATE  TABLE `rhubarb_players` (`id` INT NOT NULL AUTO_INCREMENT ,`name` VARCHAR(70) NOT NULL ,`username` VARCHAR(20) NOT NULL ,`password` VARCHAR(64) NOT NULL ,`rating_package` VARCHAR(64) NOT NULL ,`current_rating` INT NOT NULL ,PRIMARY KEY (`id`) )ENGINE = InnoDB;"
