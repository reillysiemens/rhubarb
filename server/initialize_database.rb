...
#THIS
create_rhubarb_games = "CREATE TABLE rhubarb_games (id int(11) NOT NULL AUTO_INCREMENT,winner int(11) NOT NULL,loser int(11) NOT NULL,high_score int(11) NOT NULL,low_score int(11) NOT NULL,timestamp time NOT NULL,PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;"

#IS
create_rhubarb_pending_games = "CREATE TABLE rhubarb_pending_games (id int(11) NOT NULL AUTO_INCREMENT,requested_by int(11) NOT NULL,requested_to int(11) NOT NULL,winner int(11) NOT NULL,loser int(11) NOT NULL,high_score int(11) NOT NULL,low_score int(11) NOT NULL,timestamp time NOT NULL,PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;"
